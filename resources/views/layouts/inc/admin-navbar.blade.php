<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    @endphp
    @if ($setting)
    <a class="navbar-brand ps-3" href="{{ url('/') }}">{{ $setting->website_name }}</a>
    @endif
    ...
    <!-- Navbar Search-->
    <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0"><a class="navbar-brand ps-3"></a>
